...
@router.post("/send")
async def send_email(req: SendEmailRequest, principal=Depends(require_service_auth)):
    ...
    fn_map = {
        ...
        "proposal_sent": lambda: email_send.send_proposal_sent(
            to=req.to,
            business_name=req.extra.get("business_name", "Your Business"),
            first_name=req.first_name or "",
            rep_name=req.extra.get("rep_name", ""),
            rep_email=req.extra.get("rep_email", ""),
            plan_name=req.extra.get("plan_name", ""),
            monthly_price=req.extra.get("monthly_price", ""),
            setup_fee=req.extra.get("setup_fee", ""),
            due_today=req.extra.get("due_today", ""),
            proposal_url=req.extra.get("proposal_url", ""),
            org_id=req.org_id,
        ),
        "invoice_sent": lambda: email_send.send_invoice_sent(
            to=req.to,
            business_name=req.extra.get("business_name", "Your Business"),
            first_name=req.first_name or "",
            invoice_number=req.extra.get("invoice_number", ""),
            amount=req.extra.get("amount", ""),
            rep_name=req.extra.get("rep_name", ""),
            rep_email=req.extra.get("rep_email", ""),
            invoice_url=req.extra.get("invoice_url", ""),
            recurring=bool(req.extra.get("recurring", False)),
            org_id=req.org_id,
        ),
