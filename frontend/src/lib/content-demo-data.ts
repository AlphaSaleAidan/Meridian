...
const DEMO_BUSINESSES: Record<BusinessType, DemoBusiness> = {
  ...
  peptide_shop: {
    ...
    post: {
      ...
      body: 'New BPC-157 and NAD+ lots are in the case, third-party tested with certificates on file — ask at the counter or check the QR on the label.\n\nStanding reorder customers: your usual is reserved until Saturday.',
      hashtags: ['#ApexPeptideSupply', '#Restock', '#ThirdPartyTested'],
      call_to_action: 'Call ahead and your order is bagged when you arrive',
