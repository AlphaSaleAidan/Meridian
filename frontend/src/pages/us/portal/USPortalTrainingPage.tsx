...
const MODULES: Module[] = [
  {
    ...
    lessons: [
      ...
      { id: '3', title: 'Pricing & Plans Overview', completed: false, content: [
        'Three plans — all prices in USD: Standard ($299/mo), Premium ($599/mo), Command ($1,199/mo). No setup fees. Month-to-month, no contracts.',
        ...
        'Your commission: 70% of monthly subscription value, paid every month the account stays active. A single Standard deal = $209/mo recurring. Close 10 deals = $2,090/mo passive income.',
      ]},
      { id: '4', title: 'Setting Up Your Pipeline', completed: false, content: [
        ...
        'Lead sources that work best in US: (1) Walk-ins — visit the business, ask what POS they use, mention "I noticed you\'re on Square, most Square merchants are leaving money on the table." (2) Referrals — ask every closed client for 3 introductions. (3) Local business associations — BIAs, chambers of commerce, restaurant associations.',
        'Aim for 20 new leads per week. Of those, 5 will book demos, 2–3 will receive proposals, and 1 will close. That\'s 4 deals/month = $836+/mo in recurring commissions within 60 days.',
  ...
  },
  {
    ...
    lessons: [
      { id: '6', title: 'The 60-Second Elevator Pitch', completed: false, content: [
        ...
        '"Hey [name], I work with [restaurant/cafe/shop] owners who use [their POS system]. Most of them are leaving thousands of dollars on the table every month and don\'t know it. We connect to your POS and our AI finds exactly where you\'re losing money — hidden revenue gaps, staffing inefficiencies, inventory waste. The average owner we work with discovers $2,800/month in opportunities within the first week. Can I show you a 15-minute demo?"',
        'Variations by context: If they\'re busy: "I\'ll be quick — we help [POS] users find money they\'re leaving on the table. Can I come back Thursday at 2 for 15 minutes?" If they ask what it costs: "Plans start at $299/month, but most owners find 10x that in their first week. Let me show you on your own data."',
  ...
  },
  {
    ...
    lessons: [
      { id: '14', title: 'Restaurants & Cafes', completed: false, content: [
        ...
        'Average deal size: $299–$599/mo. Restaurants love the Premium tier because Camera Intelligence shows foot traffic patterns and queue wait times.',
      ...
      { id: '15', title: 'Smoke Shops & Vape', completed: false, content: [
        ...
        'Average deal size: $299–$449/mo. Smoke shops are price-sensitive but close fast when you show the shrinkage angle.',
      ...
      { id: '16', title: 'Salons & Spas', completed: false, content: [
        ...
        'Average deal size: $299/mo. Salons are relationship-driven — the churn warning feature is your strongest closer.',
      ...
      { id: '17', title: 'Retail & Boutiques', completed: false, content: [
        ...
        'Average deal size: $299–$599/mo. Multi-SKU retailers get more value from Premium because the data volume justifies deeper analytics.',
        'Decision maker: Store owner or buyer. Best time to visit: weekday mornings before the rush. Avoid weekends entirely.',
        'US angle: "With supply chain unpredictability and rising costs, knowing exactly what to order and when saves you thousands in tied-up inventory."',
      ]},
      { id: '18', title: 'Food Trucks & QSR', completed: false, content: [
        ...
        'Average deal size: $299/mo. Food trucks are budget-conscious but appreciate mobile-friendly dashboards they can check between rushes.',
  ...
  },
  {
    ...
    lessons: [
      { id: '19', title: 'Creating Urgency Without Pressure', completed: false, content: [
        ...
        'Loss-based urgency: "Every month without Meridian is another month of leaving $2,800+ on the table. That\'s $8,400 in the next quarter alone."',
      ...
      { id: '20', title: 'Multi-Location Upsell', completed: false, content: [
        'Trigger: Any merchant with 2+ locations is a Command tier candidate ($1,199/mo). That\'s $839/mo commission for you.',
        ...
        'Close: "With Command, you see all 3 locations on one screen. The $1,199/mo pays for itself when you catch a single staffing inefficiency across locations."',
      ]},
      ...
      { id: '22', title: 'Commission Optimization', completed: false, content: [
        'Focus on retention, not just acquisition. Your 70% commission is recurring — every month the client stays, you earn. One client on Standard = $209/mo. Keep 10 clients for 12 months = $25,080/year from those 10 alone.',
        ...
        'Upsell path: Standard → Premium is a natural upgrade after 2–3 months when they\'ve seen the value. "You\'ve been loving the revenue insights. Want to add Camera Intelligence to see foot traffic too? It\'s an extra $300/mo."',
  ...
  },
  {
    ...
    lessons: [
      { id: '23', title: 'Sales Ethics Policy', completed: false, content: [
        'Never make promises Meridian can\'t keep. "Guaranteed to increase your revenue by X%" is not acceptable. Instead: "Our average merchant discovers $2,800/mo in opportunities" — that\'s a verifiable average, not a guarantee.',
      ...
      { id: '24', title: 'Data Privacy & Security', completed: false, content: [
        ...
        '(1) We never sell merchant data to third parties. (2) All data is encrypted in transit (TLS 1.3) and at rest (AES-256). (3) Data is stored in US-based infrastructure with SOC 2 compliance. (4) Merchants can delete their data and disconnect at any time.',
        'We follow US data privacy standards and applicable state privacy laws. For Camera Intelligence specifically, merchants must display signage notifying customers of camera presence. We provide signage templates.',
      ...
      { id: '25', title: 'Accurate Representations', completed: false, content: [
        'Pricing: Always quote in USD for US merchants. Standard = $299/mo, Premium = $599/mo, Command = $1,199/mo. No hidden fees. Month-to-month.',
        ...
        'Results: Use ranges and averages, not guarantees. "Merchants typically discover $1,500–$4,000/month in opportunities" is accurate. "You will make $4,000 more per month" is not.',
  ...
  },
  {
    ...
    lessons: [
      { id: '26', title: 'What is Camera Intelligence?', completed: false, content: [
        ...
        'This is a Premium/Command tier feature. It\'s the primary upsell from Standard. Monthly uplift: $300/mo (Standard → Premium upgrade).',
      ...
      { id: '28', title: 'Privacy Compliance & Signage', completed: false, content: [
        'US privacy best practices and applicable state laws require: (1) Visible signage at entrances notifying visitors that video analytics are in use. (2) A posted privacy policy explaining what data is collected and how it\'s used. (3) Data retention limits — we auto-delete raw footage after 30 days.',
        'Meridian provides: printable signage templates, a privacy policy template merchants can customize, and automatic data retention enforcement.',
        ...
        'Some states (California, Illinois, Texas, Washington) have stricter privacy requirements for video analytics. Meridian\'s signage and data handling practices meet the highest state-level standards, so merchants are covered regardless of location.',
      ]},
      ...
      { id: '30', title: 'Selling the ROI to Prospects', completed: false, content: [
        ...
        'ROI calculation: "If Camera Intelligence helps you reduce queue wait time by 30 seconds and you serve 200 customers/day, that\'s 100 minutes saved daily. At your average ticket of $15, serving even 5 more customers/day = $2,250/month in additional revenue."',
        ...
        'Close with: "You\'re already paying for security cameras. For $300/mo more, those cameras become your most valuable employee — one that watches your business 24/7 and tells you exactly how to make more money."',
      ]},
    ],
  },
  {
    id: 'quicktips',
    title: 'Quick Tips',
    description: 'Bite-sized tips for everyday selling in the US market.',
    icon: Lightbulb,
    duration: '15 min',
    category: 'Quick Reference',
    lessons: [
      { id: '31', title: 'Pricing in USD — Handling Questions', completed: false, content: [
        'All Meridian prices for US merchants are quoted and billed in USD. Standard: $299/mo, Premium: $599/mo, Command: $1,199/mo.',
        'If a merchant asks about pricing compared to competitors: "Our pricing reflects the value — most owners find 10x the subscription cost in their first week. No setup fees, no contracts, cancel anytime."',
        'Always use the $ prefix when stating amounts verbally and in writing. Keep it simple and consistent.',
        'Invoices and billing are processed in USD through Stripe. Straightforward, no surprises for the merchant.',
      ]},
      ...
      { id: '33', title: 'Sales Tax Considerations', completed: false, content: [
        ...
        'Don\'t get into tax discussions during the sale. If asked: "Sales tax is applied automatically based on your state at billing. It\'s on top of the quoted price, same as any software subscription."',
      ...
      { id: '34', title: 'Seasonal Sales Patterns in US', completed: false, content: [
  ...
  },
  {
    ...
    description: 'Step-by-step guides for connecting major US POS systems.',
    icon: Plug,
    duration: '25 min',
    category: 'Technical',
    lessons: [
      ...
      { id: '37', title: 'Clover US Configuration', completed: false, content: [
      ...
      { id: '38', title: 'Troubleshooting POS Connections', completed: false, content: [
        ...
        '"Numbers don\'t match my POS reports": (1) Timezone mismatch — ensure the merchant\'s POS timezone matches what Meridian is using. (2) Refunds/voids — we include or exclude refunds depending on the metric. Revenue = net of refunds. Transaction count = gross. (3) Currency — always verify both sides are in USD.',
  ...
  },
  {
    ...
    lessons: [
      ...
      { id: '42', title: 'Customers & Retention Intelligence', completed: false, content: [
        ...
        'Demo this by saying: "See these 23 customers flagged as At Risk? They used to spend $200/month each. That\'s $4,600/month walking out the door. Our AI caught it — your POS didn\'t."',
      ]},
      ...
      { id: '44', title: 'Anomalies, Insights & Actions', completed: false, content: [
        ...
        'The reasoning chain is key to merchant trust. When an action says "Raise Matcha Latte price to $7.00 for +$840/month," the merchant can click to see the full reasoning: the elasticity calculation, competitor pricing data, volume impact projection, and the statistical model used. Transparency builds confidence.',
      ]},
  ...
  },
  {
    ...
    lessons: [
      ...
      { id: '47', title: 'Analysis Agents (The Data Detectives)', completed: false, content: [
        ...
        'Product Intelligence: Ranks every SKU by margin, velocity, and cannibalization. Finds co-purchase patterns (items frequently bought together) and recommends bundles. Example: "Cappuccino + Croissant co-purchase rate 34%, potential $2.40 uplift per bundle."',
      ...
      { id: '48', title: 'Optimization Agents (The Money Finders)', completed: false, content: [
        'Peak Hour Optimizer: Maps transaction density by hour and day, overlays staffing data, and recommends exact headcount per hour. Example: "7–9 AM generates 47% of daily revenue but is 1 staff member short — adding 1 person recovers $520/month in walkout losses."',
        ...
        'Pricing Power: Measures price elasticity across every SKU to identify items where the merchant can safely raise prices without losing volume. Example: "4 items have inelastic demand — combined price increase potential $1,200/month."',
      ...
      { id: '49', title: 'Forecasting & Strategy Agents', completed: false, content: [
        'Revenue Forecaster: Predicts revenue for 7, 14, 30, and 90 days using AutoARIMA + LightGBM ensemble models. Includes confidence intervals and growth projections. Example: "90-day forecast projects $184K revenue with 12% growth trajectory."',
      ...
      { id: '50', title: 'Premium & Command Tier Agents', completed: false, content: [
        ...
        'Queue Monitor (Premium): Tracks real-time queue length and average wait times. Estimates revenue lost to walkaway customers. Example: "Average wait exceeds 3 minutes during 8–9 AM — estimated $320/month in walkaway losses." Combines with Peak Hour Optimizer for staffing recommendations.',
  ...
  },
  {
    ...
    lessons: [
      ...
      { id: '53', title: 'First 7 Days After Onboarding', completed: false, content: [
        ...
        'Day 3: Call the merchant. Walk them through the top 3 insights. Focus on the one with the highest dollar amount. Say: "This one insight alone — $840/month — pays for your subscription 2x over." Ask if they have questions about any of the numbers.',
  ...
  },
  {
    ...
    lessons: [
      { id: '55', title: 'The Demo Dashboard Navigation', completed: false, content: [
        'The demo lives at meridian.tips/demo. It uses pre-built realistic data — no POS connection needed. The demo auto-detects business type and adjusts all product names, prices, and industry benchmarks accordingly.',
        ...
        'The demo data is designed to tell a story. The Money Left on Table score is always between $2,500–$4,000. The top actions are always high-impact and easy to understand. The agent findings always include specific dollar amounts. Don\'t improvise — let the data speak.',
      ]},
      ...
      { id: '57', title: 'Handling Demo Questions', completed: false, content: [
        '"Is this real data?" — "This is realistic demo data modeled after actual US businesses. When you connect your POS, you\'ll see your own transactions, your own products, and your own revenue — with insights specific to your business."',
      ...
      { id: '58', title: 'Demo Mistakes to Avoid', completed: false, content: [
        ...
        'Don\'t read the screen out loud. The merchant can read. Instead, add context: "See this number? That\'s $840 per month you\'d capture just by adjusting one price. The AI did the elasticity math for you."',
...
const SECTIONS = [
  ...
  },
  {
    ...
    description: 'Handy tips for the US market.',
    moduleIds: ['quicktips'],
  },
]
