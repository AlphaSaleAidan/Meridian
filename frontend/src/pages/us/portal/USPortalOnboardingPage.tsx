          ...
          {step === 'profile' && (
            <div className="space-y-5">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                ...
                <div className="sm:col-span-2">
                  <label className="block text-xs font-medium text-[#6b7a74] mb-1.5">State</label>
          ...
          {step === 'manager' && (
            <div className="space-y-5">
              <div className="text-center">
                ...
                <p className="text-sm text-[#6b7a74] mt-1">Here's who you'll be working with in US.</p>
              </div>
                ...
                <div className="bg-[#0a0f0d] border border-[#1a2420] rounded-xl p-5">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-[#6b7a74]">US Regional Director</p>
                ...
                <div className="bg-[#0a0f0d] border border-[#1a2420] rounded-xl p-5">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-[#6b7a74]">US Admin</p>
              ...
              <div className="space-y-5">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <div className="flex gap-2">
                    <Link to="/us/portal/training" className={btnSecondary + ' border border-[#1a2420] rounded-lg px-4'}>
                      Go to Training
                    </Link>
                    <button
