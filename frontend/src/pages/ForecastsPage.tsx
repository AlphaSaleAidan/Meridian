...
export default function ForecastsPage() {
  ...
  // Combine historical + forecasted for chart
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="card p-5">
          ...
          <p className="stat-value mt-1 text-meridian-400">{formatCentsCompact(totalPredicted)}</p>
          <p className="text-xs text-slate-500 mt-1">next forecast period</p>
        </div>
        <div className="card p-5">
          <p className="stat-label">Active Forecasts</p>
          <p className="stat-value mt-1">{data.total}</p>
        </div>
        <div className="card p-5">
