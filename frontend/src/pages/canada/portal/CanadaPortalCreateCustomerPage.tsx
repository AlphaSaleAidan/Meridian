    ...
    try {
      ...
      if (supabase) {
        ...
        await supabase.from('deals').insert({
          ...
          country: 'CA',
          notes: form.notes || `Provisioned via Canada Sales Portal. Plan: ${selectedPlan.label} at $${price} CAD/mo`,
  ...
  function sendWelcomeEmail() {
    ...
    const body = [
      ...
      credentials.invoicesSent
        ? `You'll also receive two Square invoices — a setup fee and your monthly subscription. All amounts in CAD.`
        : `We'll send your invoices separately. All amounts in CAD.`,
      ``,
        ...
        <div className="space-y-4">
          <div className="card p-6 border border-[#1F1F23]">
                ...
                <button key={plan.id} onClick={() => update('plan', plan.id)}
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="text-right">
                      <p className="text-lg font-bold text-[#F5F5F7]">${plan.price} CAD</p>
            ...
            <div className="mt-4">
              ...
              <p className="text-[10px] text-[#A1A1A8]/40 mt-1">Leave blank to use standard pricing. All amounts in CAD.</p>
            </div>
          </div>
          ...
          <div className="card p-6 border border-[#17C5B0]/30 bg-[#17C5B0]/5">
            ...
            <div className="space-y-3 text-[13px]">
              ...
              <div className="flex justify-between py-3">
                ...
                <span className="text-lg font-bold text-[#17C5B0]">${price} CAD/mo</span>
              </div>
            </div>
            ...
            {rep && (
              <div className="mt-3 pt-3 border-t border-[#1F1F23]">
                <p className="text-[11px] text-[#A1A1A8]">
                  ...
                  <span className="text-[#17C5B0] font-medium"> ${Math.round(price * (rep.commission_rate / 100))} CAD/mo</span>
                </p>
              </div>
            )}
            ...
            <div className="mt-4 rounded-lg p-3 bg-[#1A8FD6]/5 border border-[#1A8FD6]/15">
              <p className="text-[11px] text-[#A1A1A8] leading-relaxed">
                ...
                and prepare their dashboard. You'll see the credentials to share with the customer. All amounts in CAD.
              </p>
            </div>
          </div>
