...
import { salesDemoData, STAGE_CONFIG, STAGE_ORDER, type SalesOverview, type Deal } from '@/lib/sales-demo-data'
...
export default function CanadaPortalDashboardPage() {
  ...
  useEffect(() => {
    Promise.all([salesDemoData.overview(), salesDemoData.deals()]).then(([o, d]) => {
      setOverview(o)
      setDeals(d)
      setLoading(false)
    })
