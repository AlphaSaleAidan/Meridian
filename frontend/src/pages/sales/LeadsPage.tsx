      ...
      {showNew && (
        <div className="card border border-[#17C5B0]/30 p-5">
          ...
          <form onSubmit={handleAddDeal} className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            ...
            <input type="number" required value={newDeal.monthly_value} onChange={e => setNewDeal(p => ({ ...p, monthly_value: e.target.value }))} className={inputClass} placeholder="Est. Monthly Revenue ($) *" />
