# Meridian Connector (software-only) — the FALLBACK path

> **Try "Connect via your camera app" (vendor-cloud) in the portal first** — for cameras with
> a supported cloud (Tuya / Smart Life and more) there is **nothing to install at all**. Use
> this LAN connector only when your cameras have no supported cloud API.
